      ...
      <div className='hangman-container'>
        <svg width="400" height="400" xmlns="http://www.w3.org/2000/svg" className="hangman">
          <g id="stand">
            ...
            <line fill="none" stroke="#ff0000" strokeWidth="3" strokeLinejoin="null" strokeLinecap="null" x1="25" y1="315" x2="371" y2="315" id="svg_24" />
          </g>
          ...
          <g id="lost" display={progress > 5 && done ? '' : 'none'}>
            <title>lost</title>
            <text x="75" y="310" fill="red" stroke="black" style={{ fontSize: '50px', color: 'red' }}>
              YOU DIED !
          </text>
            <text x="75" y="355" fill="red" stroke="black" style={{ fontSize: '50px', color: 'red' }}>
              VERY SAD !!
          </text>
          </g>
          <g id="won" display={progress < 6 && done ? '' : 'none'}>
            <title>won</title>
            <text x="75" y="310" fill="green" stroke="black" style={{ fontSize: '50px', color: 'green' }}>
              GRATS !
          </text>
            <text x="75" y="355" fill="green" stroke="black" style={{ fontSize: '50px', color: 'green' }}>
              YOU WON !!
          </text>
          </g>
        </svg>
